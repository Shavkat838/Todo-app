...
export default function Body({body}:Props) {
  ...
  return (
    <div className="max-w-[1220px] w-full grid grid-cols-4 gap-2 pt-[10px] ">
      {body
        .filter((item) => {
      ...
      <div className="max-w-[270px] w-full h-[190px] rounded-[12px] flex items-center justify-center bg-[#2C2C2C] p-[16px] shadow-md ">
        <div
          onClick={() => setOpen()}
